    ...
    <div className="min-h-screen">
      <header role="banner" className="h-[72px] border-b border-[rgba(255,255,255,0.08)] flex items-center px-[32px] bg-[rgba(10,14,20,0.95)] backdrop-blur-[16px]">
        ...
        <nav aria-label="Основная навигация" className="flex items-center gap-[16px] h-full ml-[32px]">
          ...
          <Link href="/teams" aria-current="page" className="h-full flex items-center text-[14px] text-[#a8b3c0]">Команды</Link>
      ...
      <main role="main" id="main-content" className="w-full max-w-[1600px] mx-auto px-[32px]">
        <section aria-labelledby="teams-heading" className="py-[120px_0_80px] flex justify-between gap-[40px] items-end">
          <div>
            <div className="text-[12px] tracking-normal uppercase text-[#a8b3c0] mb-4">DOTA 2 ESPORTS / ORGANIZATIONS</div>
            <h1 id="teams-heading" className="text-[48px] leading-tight tracking-tight mb-6">Команды</h1>
            <p className="max-w-[680px] text-[18px] leading-relaxed text-[#a8b3c0]">База команд Dota 2. Регистрируйте составы, подавайте заявки на турниры и ищите тиммейтов.</p>
          </div>
          <button aria-label="Подать заявку на создание команды" className="btn btn-dark px-6 py-3 text-white rounded-[6px] font-semibold border-0 cursor-pointer min-h-[44px]">
